...
//    try {
//        const response = await fetch('http://chronos.cs.elon.edu:9023/projects');
//        const data = await response.json();
//
//        // Assuming the first object in the array is a placeholder and should be skipped
//        // Use slice(1) to exclude the first object
//        summaryContent.push(...data.slice(1));
//
//        // Log the updated summaryContent for verification
//        console.log("This is the data I got from the API!! " + summaryContent);
//    } catch (error) {
